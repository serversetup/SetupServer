...
class SSSVariables():
    ...
    sss_php = ["php7.0-fpm", "php7.0-curl", "php7.0-gd", "php7.0-imap",
              "php7.0-mcrypt","php7.0-common", "php7.0-readline","php7.0-recode",
              "php7.0-mysql", "php7.0-cli", "php-memcached", "php-imagick",
              "memcached", "graphviz", "php-pear","php7.0-mbstring",
              "php7.0-bcmath","php7.0-opcache", "php7.0-zip", "php7.0-xml", "php7.0-soap"]
